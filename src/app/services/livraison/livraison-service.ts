...
export class LivraisonService {
    ...
    searchByCommon(commonSearch: CommonSearchModel): Observable<Livraison[]> {
        return this.http.post<Livraison[]>(ENDPOINTS.LIVRAISON.searchByCommon, commonSearch);
    }
    ...
    imprimerBonLivraison(id: bigint): Observable<any> {
        return this.http.get<any>(ENDPOINTS.LIVRAISON.imprimerBonLivraison(id), { headers: getHeadersPDF(), responseType: 'blob' as 'json' });
    }
