...
import { BulletinPaiRequest } from '@/shared/searchModels/bulletin-pai-request';
...
export class BulletinPaiService {
    ...
    create(bulletinPaiResponse: BulletinPaiResponse): Observable<BulletinPai> {
        return this.http.post<BulletinPai>(this.ENDPOINT.create, bulletinPaiResponse);
    }

    update(id: bigint, bulletinPaiResponse: BulletinPaiResponse): Observable<BulletinPai> {
        return this.http.put<BulletinPai>(this.ENDPOINT.update(id), bulletinPaiResponse);
    }
    ...
    getDetails(bulletinPai: BulletinPaiRequest): Observable<BulletinPaiResponse> {
        return this.http.post<BulletinPaiResponse>(this.ENDPOINT.details, bulletinPai);
    }

    getDetailsOfLivraison(bulletinPai: BulletinPaiRequest): Observable<BulletinPaiResponse> {
        return this.http.post<BulletinPaiResponse>(this.ENDPOINT.detailsOfLivraison, bulletinPai);
    }
}
