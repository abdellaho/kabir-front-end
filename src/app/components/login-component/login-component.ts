...
@Component({
    ...
    imports: [AppFloatingConfigurator, PasswordModule, CheckboxModule, InputTextModule, ButtonModule, RippleModule, SkeletonModule, ToastModule, CommonModule, ReactiveFormsModule, FormsModule],
